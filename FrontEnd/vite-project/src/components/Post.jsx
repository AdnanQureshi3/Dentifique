...
function Post({ post }) {
  ...
  return (
    <div className="w-full max-w-md mx-auto my-6 rounded-md bg-white shadow-sm border">
      ...
      {isTextOnly ? (
        <div
          className="bg-gray-50 border-y-2 border-x-1 pt-3 rounded-xl px-4 pb-3 text-sm text-gray-800 whitespace-pre-wrap 
          [&_a]:text-blue-500 [&_a]:hover:underline [&_a]:hover:text-blue-600"
